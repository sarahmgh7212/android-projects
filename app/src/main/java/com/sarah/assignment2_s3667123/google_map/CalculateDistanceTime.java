...
public class CalculateDistanceTime {
    ...
    public void getDirectionsUrl(String originLat, String originLong, String destLat, String destLong) {
        ...
        String url = "https://maps.googleapis.com/maps/api/directions/" + output + "?" + parameters +  "&key=" + "AIzaSyCzl03Q7R6d3JvIVUOKHVhaY488OHsbjb4";
